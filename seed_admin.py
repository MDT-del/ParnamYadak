...
"""
فایل: seed_admin.py
توضیح: ایجاد مدیر سیستم اولیه با مجوزهای مشخص شده
"""
...
def create_admin_user():
    """ایجاد مدیر سیستم اولیه با مجوزهای مشخص"""
    ...
    with app.app_context():
        try:
            # 1. ایجاد مجوزهای مشخص شده
            print("📋 ایجاد مجوزهای سیستم...")
            permissions_data = {
                ...
                'view_mechanics': 'مشاهده مکانیک‌ها',
            ...
            # 6. ایجاد نقش‌های اضافی با مجوزهای متناسب
            ...
            additional_roles = [
                {
                    ...
                    'permissions': [
                        ...
                        'manage_orders', 'manage_pre_orders', 'manage_customers',
                        'view_financial_reports', 'view_reports', 'view_mechanics',
                        'view_notifications', 'manage_users'
                    ]
                },
                {
                    'name': 'Employee',
            ...
            print("\n📋 نقش‌های ایجاد شده:")
            print("  👑 Admin - دسترسی کامل (17 مجوز)")
            print("  👔 Manager - مدیر (11 مجوز)")
            print("  👤 Employee - کارمند (5 مجوز)")
            print("  🎧 Support - پشتیبانی (6 مجوز)")
            print("  👁️ Viewer - بازدیدکننده (5 مجوز)")
